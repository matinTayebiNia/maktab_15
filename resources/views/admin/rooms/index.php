    ...
    <div class="container mx-auto px-4 sm:px-8 max-w-7xl ">
        <div class="py-8 ">
            <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                <h2 class="text-2xl leading-tight">اتاق ها</h2>
                <div class=" text-end ">
            ...
            <div class="mx-4 sm:mx-8  px-4 sm:px-8 py-4 overflow-x-auto ">
                ...
                <div class="inline-block bg-white p-3  w-full shadow rounded-lg overflow-hidden ">
                    <a href="/admin/rooms/create" class="flex-shrink-0 inline-block m-5 px-4 py-2 text-base
                             font-semibold text-white bg-blue-600 rounded
                             shadow-md hover:bg-blue-400 focus:outline-none focus:ring-2
                            focus:bg-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200 ">ثبت اتاق جدید
                    </a>
                    <table class=" min-w-full leading-normal  ">
                        ...
                        <?php foreach ($data as $item): ?>
                            ...
                            <tr>
                                ...
                                <td class="p-5 border-b border-gray-200 text-sm bg-white">
                                    <div class="flex">
                                        <a href="/admin/rooms/<?= $item->id ?>/edit" title="ویرایش">
    ...
    <div class="relative w-auto my-6 mx-auto max-w-3xl">
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          <span class="bg-transparent text-black opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
            ...
            <!--footer-->
            <form method="post" action="/admin/rooms/<?= rand(1, 5) ?>/delete">
                <?= method("delete") ?>
