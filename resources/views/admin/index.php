<?php if (user()->admin()->first()->email == null): ?>
    <div id="alert-danger"
        ...
        سلام <?= user()->name ?> برای استفاده از امکانات پنل و تایید شدن توسط مدیران لطفا اطلاعات خودتو کامل کن.
...
<?php elseif (user()->admin()->first()->status == false): ?>
    <div id="alert-warning"
         class="my-3  block  text-left text-white bg-orange-500 h-12 flex items-center justify-center p-4 rounded-md relative"
         role="alert">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
             class="flex-shrink-0 w-6 h-6 mx-2 stroke-current">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
