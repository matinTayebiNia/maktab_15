    ...
    <div class="container mx-auto px-4 sm:px-8 max-w-7xl ">
        <div class="py-8 ">
            <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full">
                <h2 class="text-2xl leading-tight">بیماران</h2>
                <div class=" text-end ">
                    ...
                    <table class=" min-w-full leading-normal  ">
                        ...
                        <?php foreach ($data as $item): ?>
                            <tr>
                                ...
                                <td class="p-5 border-b border-gray-200 text-sm bg-white">
                                    <p class="text-gray-900 whitespace-nowrap ">
                                        <?= $item->Type_of_disease ?>
                                    </p>
                                </td>
                                <td class="p-5 border-b border-gray-200 text-sm bg-white">
                                    <div class="flex">
                                        <a href="/admin/patients/<?= $item->id ?>/edit" title="ویرایش">
          ...
          <span class="bg-transparent text-black opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
            ...
            <div class="relative pt-8 px-14 flex-auto">
                <p class="my-4 text-slate-500 text-lg leading-relaxed">
                    ایا از حذف ادمین مورد نظر مطمئن هستید
                </p>
            </div>
            <!--footer-->
            <form method="post" action="/admin/patients/<?= rand(1, 5) ?>/delete">
                <?= method("delete") ?>
...
<script>
    ...
    function toggleModal(modalID, PatientId) {
